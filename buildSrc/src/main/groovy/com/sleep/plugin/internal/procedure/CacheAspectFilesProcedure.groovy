 ...
 */
package com.sleep.plugin.internal.procedure
...
import com.sleep.plugin.internal.AJXUtils
import com.sleep.plugin.internal.cache.VariantCache
import com.sleep.plugin.internal.concurrent.BatchTaskScheduler
import com.sleep.plugin.internal.concurrent.ITask
                    ...
                    Object call() throws Exception {
                        dirInput.file.eachFileRecurse { File item ->
                            if (AJXUtils.isAspectClass(item)) {
                                ...
                                FileLog.logI("variantCache add directory invoke: " + cacheFile.absolutePath)
                        ...
                        while (entries.hasMoreElements()) {
                            ...
                            if (!jarEntry.isDirectory() && AJXUtils.isClassFile(entryName)) {
                                ...
                                if (AJXUtils.isAspectClass(bytes)) {
                                    FileLog.logI("variantCache add jar invoke: " + cacheFile.absolutePath)
